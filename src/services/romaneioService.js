...
export const extractValidCodes = (text) => {
  ...
  return extrairCodigosDoTexto(text);
};

export { isValidCode, normalizarCodigo };
...
export const processUploadedFile = async (file) => {
  try {
    ...
    throw new Error(`Erro ao ler arquivo: ${error.message}`, { cause: error });
  }
};
